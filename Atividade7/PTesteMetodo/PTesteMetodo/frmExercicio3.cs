...
namespace PTesteMetodo
{
    public partial class frmExercicio3 : Form
    {
        ...
        private void btnRemoveOcorrenciaReplace_Click(object sender, EventArgs e)
        {
            txtPalavra1.Text = txtPalavra1.Text.ToUpper();
            txtPalavra2.Text = txtPalavra2.Text.ToUpper();
        ...
        private void btnInverteReverse_Click(object sender, EventArgs e)
        {
            //char[] letras = char[txtPalavra2.Text.Length];
